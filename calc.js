...
if(res.textContent[res.textContent.length-1]!="+" &&
res.textContent[res.textContent.length-1]!="-" && res.textContent[res.textContent.length-1]!="*"
&& res.textContent[res.textContent.length-1]!="/"){
opac.innerHTML=eval(res.textContent);
}
else{
duplicate=res.textContent.substring(0,res.textContent.length - 1);
